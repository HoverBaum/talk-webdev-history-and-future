...
const BetterMfWebsite = () => (
  ...
  >
    <header>
      <h1>
        This is <em>still</em> a motherfucking website.
      </h1>
    ...
    <p>
      ...
      <a href="http://motherfuckingwebsite.com/">grotesque pile of shit</a> into
      this easy-to-read masterpiece. It's so fucking simple and it{' '}
      <em>still</em> has all the glory of the original perfect-ass website:
    </p>
    <ul>
      <li>
        Shit's <em>still</em> lightweight and loads fast
      </li>
      <li>
        <em>Still</em> fits on all your shitty screens
      </li>
      <li>
        <em>Still</em> looks the same in all your shitty browsers
      </li>
      <li>
        The motherfucker's <em>still</em> accessible to every asshole that
        visits your site
      </li>
      <li>
        Shit's <em>still</em> legible and gets your fucking point across
      </li>
    </ul>
    ...
    <p>
      ...
      trash -- pick a minimum <code>line-height: 1.4</code> for body copy.
    ...
    <p>
      ...
      nice <code>#EEEEEE</code> if I wasn't so focused on keeping declarations
    ...
    <h3>
      Yes, this is <em>also</em> fucking satire, you fuck
    </h3>
    <p>
...
export default BetterMfWebsite
